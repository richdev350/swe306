...
<div>
  <el-card class='box-card'>
    ...
    <el-divider content-position='center' ><span class='title1' ><span class='el-icon-s-tools'> Reservation Regulations</span></span></el-divider>
    <div class="text item">
    ...
    <el-divider content-position='center'><span class='title1'><span class='el-icon-warning'> Prohibited Behaviours</span></span></el-divider>
    <div class='text item'>
    ...
    <el-divider content-position='center'><span class='title1'><span class='el-icon-paperclip'> Tips</span></span></el-divider>
    <div class='text item'>
