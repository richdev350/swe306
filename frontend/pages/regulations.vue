<template>
  <div class=''>
    ...
    <el-card class='box-card'>
      ...
      <div class='text item'>
        2. Room reservation is limited within the classroom/library operation time <b>from 08:30 to 22:30</b> (Public
      ...
      <el-divider content-position='center'><span class='title1'><span
        class='el-icon-warning'> Prohibited Behaviours</span></span>
      </el-divider>
      <div class='text item'>
      ...
      <el-divider content-position='center'><span class='title1'><span class='el-icon-paperclip'> Tips</span></span>
      </el-divider>
      <div class='text item'>
      ...
      <div class='text item'>
        ...
        borrow
        it, and return in time after use.
      </div>
    </el-card>
  </div>
</template>
